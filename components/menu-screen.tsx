...
jantinha: [
  ...
  { id: "pas3", name: "Pastel de Pizza", description: "Queijo, tomate, oregano e mais", price: 19, image: "/images/pastel-pizza.jpg", ingredients: ["Queijo", "Tomate", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas4", name: "Pastel Frango Catupiry", description: "Frango desfiado e catupiry", price: 22, image: "/images/pastel-frango.jpg", ingredients: ["Frango desfiado", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas5", name: "Pastel de Carne Seca", description: "Queijo, cebola, tomate e oregano", price: 24, image: "/images/pastel-carne-seca.jpg", ingredients: ["Carne seca", "Queijo", "Cebola", "Tomate", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas6", name: "Pastel A Moda da Casa", description: "Calabresa, tomate, mucarela, oregano e catupiry", price: 24, image: "/images/pastel-moda-casa.jpg", ingredients: ["Calabresa", "Tomate", "Mucarela", "Oregano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  ...
  { id: "pas8", name: "Pastel Brocolis com Bacon", description: "Brocolis, bacon e queijo", price: 20, image: "/images/pastel-brocolis.jpg", ingredients: ["Brocolis", "Bacon", "Queijo"], addOns: [], subcategory: "Pastel Salgado" },
