...
const menuData: Record<Category, MenuItem[]> = {
  ...
  porcoes: [
    ...
    { id: "p2", name: "Kibe", description: "Kibes bem temperados", price: 48, image: "/images/porcao-kibe.jpg", ingredients: ["Kibe", "Tempero Especial"], addOns: [], variations: [{ id: "kib-trad", name: "Tradicional", price: 45 }, { id: "kib-cat", name: "Catupiry", price: 45 }, { id: "kib-queij", name: "Coalhada", price: 45 }] },
