...
jantinha: [
  ...
  { id: "pas6", name: "Pastel A Moda da Casa", description: "Frago desfiado, Palmito, Bacon, Milho, Azeitona, Catupiry, Tomate e Oregano", price: 24, image: "/images/pastel-moda-casa.jpg", ingredients: ["Frango desfiado", "Palmito", "Bacon", "Milho", "Azeitona", "Catupiry", "Tomate", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas7", name: "Pastel de Calabresa", description: "Calabresa, tomate, cebola e queijo", price: 19, image: "/images/pastel-calabresa.jpg", ingredients: ["Calabresa", "Tomate", "Cebola", "Queijo"], addOns: [], subcategory: "Pastel Salgado" },
