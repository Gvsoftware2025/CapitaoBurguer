...
const menuData: Record<Category, MenuItem[]> = {
  burgueres: [
    ...
    { id: "19", name: "Capitao Kids", description: "Para os pequenos piratas", price: 30, image: "/images/capitao-kids.jpg", ingredients: ["Hamburguer 100g", "Queijo Prato", "Cheddar", "Bacon Crocante", "Batata Frita"], addOns: defaultAddOns },
