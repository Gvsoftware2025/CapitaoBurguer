...
const menuData: Record<Category, MenuItem[]> = {
  ...
  super_burgueres: [
    ...
    { id: "24", name: "Capitao Supremo", description: "O premium de fraldinha", price: 49, image: "/images/capitao-supremo.jpg", ingredients: ["Hamburguer 180g de Fraldinha", "Queijo Mussarela", "Catupiry", "Mostarda", "Tomate", "Alface"], addOns: addOnsOptions },
  ],
  porcoes: [
  ...
  bebidas: [
    ...
    { id: "b4", name: "Heineken 600ml", description: "Cerveja Garrafa", price: 15, image: "/images/heineken600.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Cervejas" },
    ...
    { id: "b9", name: "Brahma Zero", description: "Cerveja Sem Alcool", price: 7, image: "/images/brahma-zero-lata.png", ingredients: ["Lata"], addOns: [], subcategory: "Cervejas" },
    // Long Necks
