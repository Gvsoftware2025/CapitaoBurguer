...
jantinha: [
  ...
  { id: "pas2", name: "Pastel de Queijo", description: "Queijo Mussarela, Tomate E Oregano", price: 18, image: "/images/pastel-queijo.jpg", ingredients: ["Queijo Mussarela", "Tomate", "e Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas3", name: "Pastel de Pizza", description: "Mussarela, Presunto, Tomate, Azeitona e Oregano", price: 19, image: "/images/pastel-pizza.jpg", ingredients: ["Mussarela", "Presunto", "Tomate", "Azeitona", "e Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  ...
  { id: "pas6", name: "Pastel A Moda da Casa", description: "Frango desfiado, Palmito, Bacon, Milho, Azeitona, Catupiry, Tomate e Oregano", price: 24, image: "/images/pastel-moda-casa.jpg", ingredients: ["Frango desfiado", "Palmito", "Bacon", "Milho", "Azeitona", "Catupiry", "Tomate", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas7", name: "Pastel de Calabresa", description: "Calabresa, tomate, Mussarela, Oregano e Catupiry", price: 19, image: "/images/pastel-calabresa.jpg", ingredients: ["Calabresa", "Tomate", "Mussarela", "Oregano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas8", name: "Pastel Brocolis com Bacon", description: "Brocolis, bacon, Tomate, Mussarela, Oregano e Catupiry", price: 20, image: "/images/pastel-brocolis.jpg", ingredients: ["Brócolis", "Bacon", "Tomate", "Mussarela", "Oregano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  ...
  { id: "pas18", name: "Palmito", description: "Palmito, tomate, mussarela, Oregano e catupiry", price: 20, image: "/images/pastel-palmito.jpg", ingredients: ["Palmito", "tomate", "mussarela", "Oregano", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas19", name: "Costela", description: "Queijo mussarela, costela desfiada, alho frito, tomate, Oregano e catupiry", price: 24, image: "/images/pastel-costela.jpg", ingredients: ["Queijo mussarela", "costela desfiada", "alho frito", "tomate", "Oregano", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas20", name: "Filé ao Alho", description: "Contra filé, alho frito, tomate seco, mussarela, Oregano e catupiry", price: 24, image: "/images/pastel-file.jpg", ingredients: ["Contra filé", "alho frito", "tomate seco", "mussarela", "Oregano e Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
