...
jantinha: [
  ...
  { id: "pas2", name: "Pastel de Queijo", description: "Queijo Mussarela, Tomate E Orégano", price: 18, image: "/images/pastel-queijo.jpg", ingredients: ["Queijo Mussarela", "Tomate", "e Orégano"], addOns: [], subcategory: "Pastel Salgado" },
  ...
  { id: "pas4", name: "Pastel Frango Catupiry", description: "Frango desfiado, Tomate, Orégano, Mussarela e catupiry", price: 22, image: "/images/pastel-frango.jpg", ingredients: ["Frango desfiado", "Tomate", "Orégano", "Mussarela", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas5", name: "Pastel de Carne Seca", description: "Queijo Mussarela, Carne Seca, tomate, Catupiry e oregano", price: 24, image: "/images/pastel-carne-seca.jpg", ingredients: ["Queijo Mussarela", "Carne Seca", "Tomate", "Catupiry", "Orégano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas6", name: "Pastel A Moda da Casa", description: "Frago desfiado, Palmito, Bacon, Milho, Azeitona, Catupiry, Tomate e Orégano", price: 24, image: "/images/pastel-moda-casa.jpg", ingredients: ["Frango desfiado", "Palmito", "Bacon", "Milho", "Azeitona", "Catupiry", "Tomate", "Orégano"], addOns: [], subcategory: "Pastel Salgado" },
  ...
  { id: "pas8", name: "Pastel Brocolis com Bacon", description: "Brocolis, bacon, Tomate, Mussarela, Orégano e Catupiry", price: 20, image: "/images/pastel-brocolis.jpg", ingredients: ["Brócolis", "Bacon", "Tomate", "Mussarela", "Orégano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas9", name: "Pastel Carne com Queijo", description: "Carne, Tomate, Queijo Mussarela e Orégano", price: 21, image: "/images/pastel-carne-queijo.jpg", ingredients: ["Carne", "Tomate", "Queijo Mussarela", "Orégano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas18", name: "Palmito", description: "Palmito, tomate, mussarela, orégano e catupiry", price: 20, image: "/images/pastel-palmito.jpg", ingredients: ["Palmito", "tomate", "mussarela", "orégano", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas19", name: "Costela", description: "Queijo mussarela, costela desfiada, alho frito, tomate, orégano e catupiry", price: 24, image: "/images/pastel-costela.jpg", ingredients: ["Queijo mussarela", "costela desfiada", "alho frito", "tomate", "orégano", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas20", name: "Filé ao Alho", description: "Contra filé, alho frito, tomate seco, mussarela, orégano e catupiry", price: 24, image: "/images/pastel-file.jpg", ingredients: ["Contra filé", "alho frito", "tomate seco", "mussarela", "orégano e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas21", name: "4 Queijos", description: "Mussarela, gorgonzola, tomate, orégano, provolone e catupiry", price: 23, image: "/images/pastel-4queijo.jpg", ingredients: ["Mussarela", "gorgonzola", "tomate", "orégano", "provolone", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  // Doces
