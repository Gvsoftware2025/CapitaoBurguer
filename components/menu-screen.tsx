...
jantinha: [
  ...
  pastel: [
  // Salgados
  { id: "pas1", name: "Pastel de Carne", description: "Carne moida, tomate e oregano", price: 20, image: "/images/pastel-carne.jpg", ingredients: ["Carne moida", "Tomate", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas2", name: "Pastel de Queijo", description: "Queijo Mussarela, Tomate E Oregano", price: 20, image: "/images/pastel-queijo.jpg", ingredients: ["Queijo Mussarela", "Tomate", "e Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas3", name: "Pastel de Pizza", description: "Mussarela, Presunto, Tomate, Azeitona e Oregano", price: 20, image: "/images/pastel-pizza.jpg", ingredients: ["Mussarela", "Presunto", "Tomate", "Azeitona", "e Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas4", name: "Pastel Frango Catupiry", description: "Frango desfiado, Tomate, Oregano, Mussarela e catupiry", price: 22, image: "/images/pastel-frango.jpg", ingredients: ["Frango desfiado", "Tomate", "Oregano", "Mussarela", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas5", name: "Pastel de Carne Seca", description: "Queijo Mussarela, Carne Seca, tomate, Catupiry e oregano", price: 24, image: "/images/pastel-carne-seca.jpg", ingredients: ["Queijo Mussarela", "Carne Seca", "Tomate", "Catupiry", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas6", name: "Pastel A Moda da Casa", description: "Frango desfiado, Palmito, Bacon, Milho, Azeitona, Catupiry, Tomate e Oregano", price: 26, image: "/images/pastel-moda-casa.jpg", ingredients: ["Frango desfiado", "Palmito", "Bacon", "Milho", "Azeitona", "Catupiry", "Tomate", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas7", name: "Pastel de Calabresa", description: "Calabresa, tomate, Mussarela, Oregano e Catupiry", price: 20, image: "/images/pastel-calabresa.jpg", ingredients: ["Calabresa", "Tomate", "Mussarela", "Oregano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas8", name: "Pastel Brocolis com Bacon", description: "Brocolis, bacon, Tomate, Mussarela, Oregano e Catupiry", price: 21, image: "/images/pastel-brocolis.jpg", ingredients: ["Brócolis", "Bacon", "Tomate", "Mussarela", "Oregano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas9", name: "Pastel Carne com Queijo", description: "Carne, Tomate, Queijo Mussarela e Oregano", price: 21, image: "/images/pastel-carne-queijo.jpg", ingredients: ["Carne", "Tomate", "Queijo Mussarela", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas18", name: "Palmito", description: "Palmito, tomate, mussarela, Oregano e catupiry", price: 22, image: "/images/pastel-palmito.jpg", ingredients: ["Palmito", "tomate", "mussarela", "Oregano", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas19", name: "Costela", description: "Queijo mussarela, costela desfiada, alho frito, tomate, Oregano e catupiry", price: 26, image: "/images/pastel-costela.jpg", ingredients: ["Queijo mussarela", "costela desfiada", "alho frito", "tomate", "Oregano", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas20", name: "Filé ao Alho", description: "Contra filé, alho frito, tomate seco, mussarela, Oregano e catupiry", price: 26, image: "/images/pastel-file.jpg", ingredients: ["Contra filé", "alho frito", "tomate seco", "mussarela", "Oregano e Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas21", name: "4 Queijos", description: "Mussarela, gorgonzola, tomate, Oregano, provolone e catupiry", price: 23, image: "/images/pastel-4queijo.jpg", ingredients: ["Mussarela", "gorgonzola", "tomate", "Oregano", "provolone", "e catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  // Doces
  { id: "pas10", name: "Pastel Ovo Matine", description: "Creme de Ovomaltine", price: 18, image: "/images/pastel-ovomaltine.jpg", ingredients: ["Creme de Ovomaltine"], addOns: [], subcategory: "Pastel Doce" },
  ...
  { id: "pas16", name: "Pastel de Nutella", description: "Nutella original", price: 18, image: "/images/pastel-nutella.jpg", ingredients: ["Nutella original"], addOns: [], subcategory: "Pastel Doce" },
