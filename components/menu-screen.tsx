...
jantinha: [
  ...
  { id: "pas18", name: "Palmito", description: "Palmito, tomate, mussarela, orégano e catupiry", price: 20, image: "/images/pastel-palmito.jpg", ingredients: ["Calabresa", "Tomate", "Mucarela", "Oregano", "Catupiry"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas19", name: "Costela", description: "Queijo mussarela, costela desfiada, alho frito, tomate, orégano e catupiry", price: 24, image: "/images/pastel-costela.jpg", ingredients: ["Calabresa", "Tomate", "Cebola", "Queijo"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas20", name: "Filé ao Alho", description: "Contra filé, alho frito, tomate seco, mussarela, orégano e catupiry", price: 21, image: "/images/pastel-file.jpg", ingredients: ["Brocolis", "Bacon", "Queijo"], addOns: [], subcategory: "Pastel Salgado" },
  { id: "pas21", name: "4 Queijos", description: "Mussarela, gorgonzola, tomate, orégano, provolone e catupiry", price: 23, image: "/images/pastel-4queijo.jpg", ingredients: ["Carne", "Tomate", "Mucarela", "Oregano"], addOns: [], subcategory: "Pastel Salgado" },
  // Doces
