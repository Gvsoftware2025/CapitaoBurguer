...
const menuData: Record<Category, MenuItem[]> = {
  burgueres: [
    { id: "1", name: "Capitao Classico", description: "O tradicional que conquistou os mares", price: 25, image: "/images/burger-classico.jpg", ingredients: ["Hamburguer 150g", "Queijo Prato", "Tomate"], addOns: addOnsOptions },
    { id: "2", name: "Capitao Bacon", description: "Para os amantes de bacon", price: 28, image: "/images/burger-bacon.jpg", ingredients: ["Hamburguer 150g", "Queijo Prato", "Bacon", "Cebola Caramelizada"], addOns: addOnsOptions },
    { id: "3", name: "Capitao Cheddar", description: "Explosao de cheddar cremoso", price: 28, image: "/images/burger-cheddar.jpg", ingredients: ["Hamburguer 150g", "Cheddar Cremoso", "Bacon Crocante"], addOns: addOnsOptions },
    { id: "4", name: "Capitao Salada", description: "Fresquinho e saboroso", price: 28, image: "/images/burger-classico.jpg", ingredients: ["Hamburguer 150g", "Queijo Prato", "Picles", "Tomate", "Cebola Roxa"], addOns: addOnsOptions },
    { id: "5", name: "Capitao Onion", description: "Com onions crocantes", price: 30, image: "/images/burger-bacon.jpg", ingredients: ["Hamburguer 150g", "Queijo Prato", "Bacon Crocante", "Molho Barbecue", "Onions"], addOns: addOnsOptions },
    { id: "6", name: "Capitao Gorgonzola", description: "Sabor sofisticado", price: 30, image: "/images/burger-gourmet.jpg", ingredients: ["Hamburguer 150g", "Queijo Gorgonzola", "Mel", "Rucula"], addOns: addOnsOptions },
    { id: "7", name: "Capitao Harry", description: "Magico e delicioso", price: 30, image: "/images/burger-bacon.jpg", ingredients: ["Hamburguer 150g", "Queijo Mussarela", "Catupiry", "Alho Frito", "Bacon Crocante"], addOns: addOnsOptions },
  ...
  super_burgueres: [
    { id: "11", name: "Capitao Chicken", description: "Frango empanado especial", price: 38, image: "/images/burger-chicken.jpg", ingredients: ["Hamburguer de Frango", "Queijo Prato", "Catupiry", "Bacon Crocante"], addOns: addOnsOptions },
    { id: "12", name: "Capitao Hulk", description: "Para os famintos de verdade", price: 38, image: "/images/burger-duplo.jpg", ingredients: ["Hamburguer 150g", "Queijo Prato", "Hamburguer de Pernil", "Bacon Crocante", "Requeijao Cremoso", "Alface Fresca", "Tomate", "Cebola"], addOns: addOnsOptions },
    { id: "13", name: "Capitao Nordestino", description: "Sabor do sertao", price: 38, image: "/images/burger-bacon.jpg", ingredients: ["Hamburguer 150g", "Queijo Mussarela", "Catupiry", "Carne Seca"], addOns: addOnsOptions },
    { id: "14", name: "Capitao Empoderado", description: "Costela suculenta", price: 38, image: "/images/burger-duplo.jpg", ingredients: ["Hamburguer de Costela 180g", "Barbecue na Base", "Muito Queijo", "Muito Bacon", "Onions"], addOns: addOnsOptions },
    { id: "15", name: "Capitao Duca", description: "Completo e irresistivel", price: 38, image: "/images/burger-cheddar.jpg", ingredients: ["Hamburguer 150g", "Queijo Empanado", "Ovo", "Alface", "Tomate", "Cebola Roxa"], addOns: addOnsOptions },
    { id: "16", name: "Capitao da Casa", description: "O monstro da casa", price: 38, image: "/images/burger-duplo.jpg", ingredients: ["Hamburguer 300g", "Queijo Mussarela", "Bacon", "Ovo", "Catupiry", "Rucula Fresca"], addOns: addOnsOptions },
    { id: "17", name: "Capitao Eclipse", description: "Triplo poder", price: 38, image: "/images/burger-duplo.jpg", ingredients: ["3x Hamburguer 100g", "Maionese da Casa", "Muito Queijo", "Bacon Crocante", "Cebola Caramelizada", "Alface Fresca"], addOns: addOnsOptions },
    { id: "18", name: "Capitao America", description: "O lendario recheado", price: 38, image: "/images/burger-bacon.jpg", ingredients: ["Hamburguer 200g Recheado com Mussarela", "Queijo Mussarela", "Maionese da Casa", "Bacon Crocante", "Alface Fresca", "Tomate", "Cebola Roxa"], addOns: addOnsOptions },
    { id: "22", name: "Capitao Costela", description: "Com costela desfiada", price: 38, image: "/images/burger-duplo.jpg", ingredients: ["Hamburguer 150g", "Queijo Mussarela", "Catupiry", "Alho Frito", "Costela Desfiada", "Rucula"], addOns: addOnsOptions },
    { id: "23", name: "Capitao Bauru", description: "Contra-file especial", price: 38, image: "/images/burger-bacon.jpg", ingredients: ["Hamburguer 200g de Contra-File", "Queijo Mussarela", "Catupiry", "Tomate", "Rucula Fresca"], addOns: addOnsOptions },
    { id: "24", name: "Capitao Supremo", description: "O premium de fraldinha", price: 49, image: "/images/burger-gourmet.jpg", ingredients: ["Hamburguer 180g de Fraldinha", "Queijo Mussarela", "Catupiry", "Mostarda", "Tomate", "Alface"], addOns: addOnsOptions },
  ],
  porcoes: [
    { id: "p1", name: "Batata Frita", description: "Batatas fritas crocantes com tempero especial", price: 8, image: "/images/porcao-batata.jpg", ingredients: ["Batata Frita", "Tempero Especial"], addOns: [], variations: [{ id: "bat-ind", name: "Individual", price: 8 }, { id: "bat-meia", name: "Meia", price: 20 }, { id: "bat-int", name: "Inteira", price: 30 }] },
    ...
    { id: "p5", name: "Pastelzinho", description: "Pastelzinhos fritos variados", price: 40, image: "/images/porcao-coxinha.jpg", ingredients: ["Pastelzinho Frito"], addOns: [] },
    { id: "p6", name: "Dadinho de Tapioca", description: "Dadinhos de tapioca com queijo coalho", price: 45, image: "/images/porcao-coxinha.jpg", ingredients: ["Tapioca", "Queijo Coalho"], addOns: [] },
    ...
    { id: "p8", name: "Calabresa Acebolada", description: "Calabresa fatiada com cebola", price: 40, image: "/images/porcao-picanha.jpg", ingredients: ["Calabresa", "Cebola"], addOns: [] },
    { id: "p9", name: "Contra File", description: "Porcao de contra file grelhado", price: 70, image: "/images/porcao-picanha.jpg", ingredients: ["Contra File Grelhado"], addOns: [] },
    { id: "p10", name: "Fraldinha na Mostarda", description: "Fraldinha ao molho de mostarda", price: 60, image: "/images/porcao-picanha.jpg", ingredients: ["Fraldinha", "Molho Mostarda"], addOns: [] },
    ...
    { id: "p12", name: "Salame", description: "Porcao de salame fatiado", price: 28, image: "/images/porcao-picanha.jpg", ingredients: ["Salame Fatiado"], addOns: [] },
    { id: "p13", name: "Palmito", description: "Porcao de palmito", price: 32, image: "/images/porcao-batata.jpg", ingredients: ["Palmito"], addOns: [] },
    { id: "p14", name: "Azeitona", description: "Porcao de azeitonas", price: 10, image: "/images/porcao-batata.jpg", ingredients: ["Azeitonas"], addOns: [] },
    { id: "p15", name: "Ovo de Codorna", description: "Unidade de ovo de codorna", price: 0.5, image: "/images/porcao-coxinha.jpg", ingredients: ["Ovo de Codorna"], addOns: [] },
    { id: "p16", name: "Tabua de Frios", description: "Salame, Presunto, Mussarela, Ovo de Codorna, Azeitona, Palmito, Tomate", price: 80.00, image: "/images/porcao-picanha.jpg", ingredients: ["Salame", "Presunto", "Mussarela", "Ovo de Codorna", "Azeitona", "Palmito", "Tomate"], addOns: [] },
  ],
  bebidas: [
    // Cervejas
    { id: "b1", name: "Antarctica 600ml", description: "Cerveja Garrafa", price: 10, image: "/images/bebida-cerveja.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Cervejas" },
    { id: "b2", name: "Skol 600ml", description: "Cerveja Garrafa", price: 12, image: "/images/bebida-cerveja.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Cervejas" },
    { id: "b3", name: "Original 600ml", description: "Cerveja Garrafa", price: 13, image: "/images/bebida-cerveja.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Cervejas" },
    { id: "b4", name: "Heineken 600ml", description: "Cerveja Garrafa", price: 15, image: "/images/bebida-cerveja.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Cervejas" },
    { id: "b5", name: "Brahma Lata", description: "Cerveja Lata", price: 6, image: "/images/bebida-cerveja.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Cervejas" },
    { id: "b6", name: "Antarctica Lata", description: "Cerveja Lata", price: 6, image: "/images/bebida-cerveja.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Cervejas" },
    { id: "b7", name: "Skol Lata", description: "Cerveja Lata", price: 6, image: "/images/bebida-cerveja.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Cervejas" },
    { id: "b8", name: "Original Lata", description: "Cerveja Lata", price: 8, image: "/images/bebida-cerveja.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Cervejas" },
    { id: "b9", name: "Brahma Zero", description: "Cerveja Sem Alcool", price: 7, image: "/images/bebida-cerveja.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Cervejas" },
    // Long Necks
    { id: "b10", name: "Heineken", description: "Long Neck", price: 10, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b11", name: "Spaten", description: "Long Neck", price: 9, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b12", name: "Corona", description: "Long Neck", price: 10, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b13", name: "Budweiser", description: "Long Neck", price: 9, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b14", name: "Imperio", description: "Long Neck", price: 6, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b15", name: "Smirnoff Ice", description: "Long Neck", price: 9, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b16", name: "Ice Cabare", description: "Long Neck", price: 9, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    { id: "b17", name: "Ice 51", description: "Long Neck", price: 9, image: "/images/bebida-cerveja.jpg", ingredients: ["Long Neck"], addOns: [], subcategory: "Long Necks" },
    // Aguas
    { id: "b18", name: "Agua Mineral sem Gas", description: "Garrafa", price: 3, image: "/images/bebida-refrigerante.jpg", ingredients: ["Garrafa"], addOns: [], subcategory: "Aguas" },
    { id: "b19", name: "Agua Mineral com Gas", description: "Garrafa", price: 4, image: "/images/bebida-refrigerante.jpg", ingredients: ["Garrafa"], addOns: [], subcategory: "Aguas" },
    { id: "b20", name: "Agua Tonica", description: "Garrafa", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Garrafa"], addOns: [], subcategory: "Aguas" },
    { id: "b24", name: "H2O", description: "Agua Saborizada", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Garrafa"], addOns: [], subcategory: "Aguas" },
    // Sucos
    { id: "b21", name: "Suco Del Valle", description: "Caixa", price: 7, image: "/images/bebida-suco.jpg", ingredients: ["Caixa"], addOns: [], subcategory: "Sucos" },
    // Energeticos
    { id: "b22", name: "Red Bull", description: "Lata", price: 15, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Energeticos" },
    { id: "b23", name: "Monster", description: "Lata", price: 12, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Energeticos" },
    // Refrigerantes
    { id: "b25", name: "Coca-Cola Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b26", name: "Coca-Cola Zero Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b27", name: "Guarana Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b28", name: "Sprite Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b29", name: "Schweppes Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b30", name: "Fanta Laranja Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b31", name: "Fanta Uva Lata", description: "Lata", price: 6, image: "/images/bebida-refrigerante.jpg", ingredients: ["Lata"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b32", name: "Coca-Cola 290ml", description: "Garrafa", price: 5, image: "/images/bebida-refrigerante.jpg", ingredients: ["290ml"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b33", name: "Coca-Cola 600ml", description: "Garrafa", price: 8, image: "/images/bebida-refrigerante.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b34", name: "Guarana 600ml", description: "Garrafa", price: 8, image: "/images/bebida-refrigerante.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b35", name: "Sprite 600ml", description: "Garrafa", price: 8, image: "/images/bebida-refrigerante.jpg", ingredients: ["600ml"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b36", name: "Coca-Cola 1L", description: "Garrafa", price: 10, image: "/images/bebida-refrigerante.jpg", ingredients: ["1 Litro"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b37", name: "Guarana 1L", description: "Garrafa", price: 10, image: "/images/bebida-refrigerante.jpg", ingredients: ["1 Litro"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b38", name: "Coca-Cola 2L", description: "Garrafa", price: 15, image: "/images/bebida-refrigerante.jpg", ingredients: ["2 Litros"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b39", name: "Sprite 2L", description: "Garrafa", price: 12, image: "/images/bebida-refrigerante.jpg", ingredients: ["2 Litros"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b40", name: "Fanta Laranja 2L", description: "Garrafa", price: 12, image: "/images/bebida-refrigerante.jpg", ingredients: ["2 Litros"], addOns: [], subcategory: "Refrigerantes" },
    { id: "b41", name: "Guarana 2L", description: "Garrafa", price: 12, image: "/images/bebida-refrigerante.jpg", ingredients: ["2 Litros"], addOns: [], subcategory: "Refrigerantes" },
  ],
  combos: [
