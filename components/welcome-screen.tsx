...
{/* Social icons with animated glow */}
        <div className="flex flex-row items-center justify-center gap-6 sm:gap-10 mt-auto pb-4">
          ...
          <button
            ...
            className="group flex flex-col items-center gap-2.5 transition-all duration-300 hover:scale-110"
            aria-label="WhatsApp"
          >
            <div 
            ...
            <span className="text-amber-100 text-sm sm:text-base font-semibold" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.9)' }}>WhatsApp</span>
          </button>
          ...
          >
            ...
            <span className="text-amber-100 text-sm sm:text-base font-semibold" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.9)' }}>Instagram</span>
          </button>
          ...
          >
            ...
            <span className="text-amber-100 text-sm sm:text-base font-semibold" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.9)' }}>Localizacao</span>
          </button>
        </div>
      </div>
