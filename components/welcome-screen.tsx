...
{/* Social icons */}
        <div className="flex flex-row items-center justify-center gap-5 sm:gap-8">
          ...
          >
            <div 
              className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center icon-glow-green"
              style={{
                background: 'linear-gradient(145deg, #5A5A5A 0%, #3A3A3A 40%, #252525 100%)',
                border: '3px solid #D4AF37',
              }}
            >
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#25D366]" style={{ filter: 'drop-shadow(0 0 10px rgba(37,211,102,1))' }} fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div 
              className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center icon-glow-pink"
              style={{
                background: 'linear-gradient(145deg, #5A5A5A 0%, #3A3A3A 40%, #252525 100%)',
                border: '3px solid #D4AF37',
              }}
            >
              <svg className="w-6 h-6 sm:w-8 sm:h-8" style={{ filter: 'drop-shadow(0 0 10px rgba(228,64,95,1))' }} fill="url(#ig-gradient)" viewBox="0 0 24 24">
                <defs>
          ...
          >
            <div 
              className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center icon-glow-red"
              style={{
                background: 'linear-gradient(145deg, #5A5A5A 0%, #3A3A3A 40%, #252525 100%)',
                border: '3px solid #D4AF37',
              }}
            >
              <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#EA4335]" style={{ filter: 'drop-shadow(0 0 10px rgba(234,67,53,1))' }} fill="currentColor" viewBox="0 0 24 24">
